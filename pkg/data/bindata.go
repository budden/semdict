...
func templatesArticleeditHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/senseedit.t.html", size: 1094, mode: os.FileMode(420), modTime: time.Unix(1553095969, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"templates/senseedit.t.html":      templatesArticleeditHtml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": &bintree{nil, map[string]*bintree{
		"senseedit.t.html":      &bintree{templatesArticleeditHtml, map[string]*bintree{}},
